...
| 01/02 ~ 01/02 | ✅ Auth(Email)                                    |
| 01/05 ~ 01/08 | ✅ 회원정보 수정                                  |
| 01/12 ~ 01/14 | ✅ 가족 그룹 시스템 (Core System)                 |
| 01/15 ~ 01/22 | ✅ 피드(Post)                                     |
| 01/21 ~ 01/21 | ✅ 피드 좋아요                                    |
| 01/22 ~ 01/22 | ✅ 피드 댓글                                      |
| 01/26 ~ 01/26 | ✅ 리팩토링을 위한 디자인패턴 디깅 작업 및 문서화 |
| 01/27 ~ 01/27 | ✅ 리팩토링(UI, 로직 분리)                        |
| 01/28 ~ 01/29 | 성능 및 캐싱 최적화 작업                          |
| 01/28 ~ 01/28 | UI/UX 작업, 추가기능 작업(소셜로그인)             |
| 01/29 ~ 01/29 | README 수정 및 배포                               |
| / ~ /         | 캘린더 페이지                                     |
| / ~ /         | 갤러리 페이지                                     |
...
- [ ] **Milestone 10: 리팩토링 및 코드 품질 개선**
  ...
  - [ ] Query Key 및 API 최적화
    - [ ] 전체 코드 검토. 특히 provider (자원 낭비, 성능, 보안) AI 체크
...
- [ ] **Milestone 11: post관련 리팩토링 및 코드 품질 개선**
  ...
  - [x] 게시글 수정/삭제 테스트
  - [x] "내 글" 표시 (isMine) 테스트
  - [ ] **가족 탈퇴 시 해당 멤버의 게시글 CASCADE 삭제 테스트**
  - [ ] **가족 탈퇴 시 해당 멤버의 댓글 CASCADE 삭제 테스트**
  - [ ] **가족 탈퇴 시 해당 멤버의 sotrage(이미지) 삭제 테스트**

- [ ] **Milestone11: UI/UX 디자인 최종화**
...
- [ ] **Milestone: 서버 성능 최적화**
  - [ ] API 최적화
    - [ ] ⚠️ post/like/comment 조인 쿼리 최적화 검토(지금 너무많은 조인을 하고있음)
